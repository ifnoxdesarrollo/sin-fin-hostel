...
import noteapp.demo.Services.NoteService;
...
public class NoteController {
    ...
    @PutMapping("/notes/categories/{id}")
    public ResponseEntity<HttpStatus> addCategory(@RequestBody List<Category> category, @PathVariable Long id) {
        try {
            noteService.setCategory(category, id);
